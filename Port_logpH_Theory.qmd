...
In de vorige portfolio-opdracht zag je dat het concept van entropie in allerlei schijnblijkelijk verschillende vakgebieden opduikt, waaronder  informatietheorie, thermodynamica, sociale wetenschappen en de biodiversiteit. Hierbij zagen we steeds dezelfde wiskundige vorm, telkens anders geïnterpreteerd. Dat was geen toeval.

In deze opdracht bekijken je een tweede voorbeeld van zo'n terugkerende vorm: de logaritme. Je gebruikt hem zodra je met de pH rekent, zoals we hebben gedaan bij het vak *Chemie van het leven*. Maar dezelfde functie duikt op als je kijkt naar hoe het metabolisme van een dier samenhangt met zijn lichaamsgewicht, hoe sterk een aardbeving is, of hoe hard een geluid klinkt. Aan het eind van deze opdracht kun je zelf uitleggen waarom dat zo is.
...
**Vraag:** Welke van deze eigenschappen van de logaritme verwacht je nodig te hebben om zo dadelijk het verband tussen massa en metabolisme te analyseren? Licht je antwoord toe.
...
::: aside
Vergelijk dit met de entropie-splitsing uit de vorige opdracht: $H(\text{fenotype}) = H(\text{soort}) + H(\text{fenotype}\mid\text{soort})$. Ook daar leken meer biodiversiteit én meer ordening (canalisatie) elkaar tegen te spreken, tot bleek dat het om twee aparte termen ging.
:::
...
**Vraag 1:** Plot hieronder de datapunten aan de hand van de vectoren die gegeven zijn. Waarom ziet het er anders uit dan de gegeven figuur?

```{r}
# gebruik de functie plot()
```

**Vraag 2:** Los het probleem op: hoe zou je ervoor kunnen zorgen dat de data goed leesbaar wordt? Wat voor verband kunnen we nu afleiden?
...
**Vraag 3:** Leg nu in woorden uit waarom de gebruikte methode werkt, en relateer dat aan de machtsformule.
...
**Vraag 4:** Vul dit in bij de machtsformule, waarbij de gemeten variabele het totale metabolisme is. Maak gebruik van de rekenregels van de logaritme om een uitdrukking te krijgen voor de totale metabole intensiteit.
...
**Vraag 5:** Probeer nu een relatie te vinden tussen de massa en het totale metabolisme. Plot deze relatie.
...
**Vraag 6:** Wat kun je opmerken over het effect van een grotere massa op de totale metabole snelheid? En op de massa-specifieke metabole snelheid?

 > Jouw antwoord

**Vraag 7:** Gebruik de rekenregels van de logaritme en je eerdere antwoorden om een waarde voor de exponent $b$ te vinden. Hint: gebruik de functie \textrm{lm()} om een relevante waarde te vinden. Met \textrm{?lm()} vind je hoe je deze kunt gebruiken.

 > Jouw antwoord
 
### Terug naar de paradox

**Vraag 8:** Je vond zojuist twee exponenten: één voor het verband tussen massa en massa-specifiek metabolisme, en één voor massa en totaal metabolisme. Laat met de rekenregels van de logaritme zien hoe deze twee exponenten met elkaar samenhangen (hint: totaal = specifiek × massa, dus $M^1$ komt erbij). Los hiermee de muis-olifant-paradox formeel op.
