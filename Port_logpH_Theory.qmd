...
![De massa-specifieke metabolisme snelheid van verschillende zoogdieren uitgezet tegen hun (gemiddelde) massa. (@randall2002eckert)](evo-devo/data_schaling.png){#fig-massa-metabolisme}
...
::: {#exr-plot_log_data}
Los het probleem op: hoe zou je ervoor kunnen zorgen dat de data goed leesbaar wordt? Wat voor verband kunnen we nu afleiden? Tip: kijk goed naar de assen in @fig-massa-metabolisme.
:::
...
Om Figuur @fig-massa-metabolisme te repliceren heb je een transformatie uitgevoerd op één van de assen. Doe hetzelfde nu voor de andere as. 
...
::: {#exr-uitleg_plot_log}
Leg nu in woorden uit waarom de gebruikte methode werkt, en relateer dat aan de machtsformule en de rekenregels genoemd in het practicum-onderdeel van deze portfolio-opdracht.
:::
